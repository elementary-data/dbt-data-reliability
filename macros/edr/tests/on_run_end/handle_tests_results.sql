  ...
  {% for result in results %}
    ...
    {% if node.resource_type == 'test' %}
      ...
      {% for elementary_test_results_row in elementary_test_results_rows %}
        ...
        {% set elementary_test_results_row = elementary.dict_update(elementary_test_results_row, {'status': status, 'failures': failures, 'invocation_id': invocation_id, 
        ...
        {% if render_result_rows %}
          {% set elementary_test_results_row = elementary.dict_update(elementary_test_results_row, {"result_rows": elementary.render_result_rows(elementary_test_results_row.result_rows)}) %}
        {% endif %}
