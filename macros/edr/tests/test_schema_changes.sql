{% test schema_changes(model) %}
    ...
    {%- if execute and flags.WHICH in ['test', 'build'] %}
        ...
        {% set temp_table_relation = elementary.create_elementary_test_table(database_name, tests_schema_name, compiled_test_id, 'schema_changes', column_snapshot_query) %}
        ...
        {% set alerts_temp_table_relation = elementary.create_elementary_test_table(database_name, tests_schema_name, compiled_test_id, 'schema_changes_alerts', schema_changes_alert_query) %}
