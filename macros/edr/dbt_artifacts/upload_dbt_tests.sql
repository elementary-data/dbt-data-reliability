...
{% macro flatten_test(node_dict) %}
    ...
    {% set default_description = elementary.get_default_description(
        test_short_name, test_namespace
    ) %}
    ...
    {% set flatten_test_metadata_dict = {
        ...
        "quality_dimension": meta_dict.get("quality_dimension")
        or elementary.get_quality_dimension(test_short_name, test_namespace),
    } %}
