...
{% macro flatten_model(node_dict) %}
    ...
    {% set flatten_model_metadata_dict = elementary.dict_merge(flatten_model_metadata_dict, {"metadata_hash": elementary.get_artifact_metadata_hash(flatten_model_metadata_dict)}) %}
