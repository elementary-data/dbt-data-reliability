...
{% materialization incremental, adapter = "snowflake", supported_languages = [
    "sql",
    "python",
] %}
...
{% materialization incremental, adapter = "bigquery", supported_languages = [
    "sql",
    "python",
] %}
...
{% materialization incremental, adapter = "spark", supported_languages = [
    "sql",
    "python",
] %}
...
{% materialization incremental, adapter = "databricks", supported_languages = [
    "sql",
    "python",
] %}
