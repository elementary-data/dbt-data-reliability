...
{% materialization table, adapter = "snowflake", supported_languages = [
    "sql",
    "python",
] %}
...
{% materialization table, adapter = "bigquery", supported_languages = [
    "sql",
    "python",
] %}
...
{% materialization table, adapter = "databricks", supported_languages = [
    "sql",
    "python",
] %}
