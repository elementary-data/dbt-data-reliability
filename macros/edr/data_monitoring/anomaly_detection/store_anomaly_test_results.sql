...
{% macro get_anomaly_test_result_row(flattened_test, anomaly_scores_rows) %}
  ...
  {%- set test_params = elementary.dict_merge(test_params, test_configuration) %}
  ...
  {%- set elementary_test_row = elementary.dict_merge(elementary_test_row, test_result_dict) %}
