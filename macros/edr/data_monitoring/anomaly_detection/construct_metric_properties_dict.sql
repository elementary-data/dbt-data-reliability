{% macro construct_metric_properties_dict(timestamp_column, where_expression, time_bucket, freshness_column=none, event_timestamp_column=none,seasonality=none) %}
