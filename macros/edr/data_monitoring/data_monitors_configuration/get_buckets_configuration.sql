...
{% macro get_global_min_bucket_end() %}
    {%- set global_min_bucket_end = "'"~ (run_started_at - modules.datetime.timedelta(elementary.get_config_var('days_back') + 1)).strftime("%Y-%m-%d 00:00:00") ~"'" %}
