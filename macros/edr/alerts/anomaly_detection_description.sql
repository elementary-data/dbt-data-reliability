...
{% macro freshness_description() %}
    'Last update was at ' || source_value || ', ' || abs(round(latest_metric_value/3600,2)) || ' hours ago. Usually the table is updated within ' || abs(round(training_avg/3600,2)) || ' hours.'
{% endmacro %}
