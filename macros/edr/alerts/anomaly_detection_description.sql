...
{% macro freshness_description() %}
    'The table ' || full_table_name || ' last update was ' || abs(round(latest_metric_value/60,2)) || ' hours ago. The average for this metric is ' || abs(round(training_avg/60,2)) || ' hours.'
{% endmacro %}
