{% macro empty_query_history() %}
    {{ elementary.empty_table([
        ('id', 'long_string'),
        ('job_id', 'long_string'),
        ('statement_type', 'long_string'),
        ('start_time', 'long_string'),
        ('end_time', 'long_string'),
        ('state', 'long_string'),
        ('source_db', 'long_string'),
        ('source_schema', 'long_string'),
        ('source_table', 'long_string'),
        ('dest_db', 'long_string'),
        ('dest_schema', 'long_string'),
        ('dest_table', 'long_string'),
    ]) }}
{% endmacro %}
