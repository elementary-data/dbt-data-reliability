{% macro empty_alerts() %}
    {{ elementary.empty_table([('alert_id','string'),('data_issue_id','string'),('test_execution_id','string'),('detected_at','timestamp'),('database_name','string'),('schema_name','string'),('table_name','string'),('column_name','string'),('alert_type','string'),('sub_type','string'),('alert_description','string'),('owners','string'),('tags','string'),('alert_results_query','string'),('other','string'),('test_name','string'),('test_params','long_string'),('severity','string'),('status','string')]) }}
{% endmacro %}
