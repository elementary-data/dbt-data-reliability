...
{% macro get_tables_for_alerts() %}
    ...
    {% set tables_for_alerts = result_column_to_list(tables_for_alerts_query) %}
...
{% macro get_columns_for_alerts() %}
    ...
    {% set columns_for_alerts = result_column_to_list(columns_for_alerts_query) %}
...
{% macro get_schemas_for_alerts() %}
    ...
    {% set schemas_for_alerts = result_column_to_list(schemas_for_alerts_query) %}
