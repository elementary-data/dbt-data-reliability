...
Elementary has 2 offerings: Elementary OSS package and Elementary Cloud Platform.

- **Elementary dbt package**
  - For basic data monitoring and dbt artifacts collection, Elementary offers this dbt package. The package adds logging, artifacts uploading, and Elementary tests (anomaly detection and schema) to your project.
- **Elementary python package**
