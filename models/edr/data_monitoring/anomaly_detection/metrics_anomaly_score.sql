...
time_window_aggregation as (
    ...
    select
        ...
        {{ elementary.stddev('metric_value') }} over (partition by metric_name, full_table_name, column_name order by bucket_start asc rows between unbounded preceding and current row) as training_stddev,
